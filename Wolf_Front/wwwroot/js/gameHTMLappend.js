        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 rightcontent">
                ...
                <div class="dialogue" style="background-color: transparent;">
                    <input type="hidden" value="黑夜" id="Day" style="background-color: transparent; border-style: none;" readonly="readonly">
                    <!--<input type="button" onclick="ChangeDay()" value="換天"  style="background-color: transparent;"/>-->
                    <!--test push-->
                    <div class="row" id="background" style="background-color:rgba(104, 157, 186, 0.6);margin-left:3%;padding-top:3%">
                        <div class="col-5 " style=" background-color: #253641; margin-left: 5%; margin-bottom: 5%;">
                            <div class="container">
                                <div class="row">&nbsp;</div>
                                <div class="row">
                            ...
                            <div class="row" style="padding:0">
                                ...
                                <div class="col d-flex" style="padding-left:1%">
                ...
                <div class="leave">
                    <button class="glow-on-hover" type="button" style="margin-left:60%;margin-top: 10%;">離開</button>
                </div>
            </div>
        </div>
    </div>
