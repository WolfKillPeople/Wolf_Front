        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content user_Choiceimg">
                ...
                <div class="d-flex row">
                    ...
                    <img aria-label="Close"  class="btn users_pic" src="https://i.imgur.com/9Pbvhnk.png"
                        alt="girl1" onclick="changePICS(this)">
                    <img aria-label="Close"  class="btn users_pic" src="https://i.imgur.com/ayhI3DJ.png"
                        alt="girl2" onclick="changePICS(this)">
                    <img aria-label="Close"  class="btn users_pic" src="https://i.imgur.com/XFglbZc.png"
