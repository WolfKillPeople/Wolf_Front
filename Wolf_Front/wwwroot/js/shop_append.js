$('body').append(`
    ...
    <div class="header">
        ...
        <div class="container"><!--modal fade  tabindex="-1" aria-hidden="true" id="open_roleCard" aria-labelledby="open_roleCard"--!>
            <div class="row">
                <div class="col-6">
   ...
   <div class="side-bar">
        <ul>
            ...
            <li><button class="ChooseBtn" id="roleBtn"  onclick="RoleClick()">角色卡</button><li>   <!--data-toggle="modal" data-target="#open_roleCard"--!>
            <li><button class="ChooseBtn" id="signBtn" >頭項選擇</button><li>
        </ul>
    </div>`)