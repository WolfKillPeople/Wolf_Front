    ...
    $('body').append(`
                ...
                <div class="wrap">
                    <div class="container">
                        ...
                        <div class="backgame">
                            <a class="btn-reveal-goodwin back btn" href="#">
                                ...
                                <div class="border-top-left-goodwin"></div>來去抽獎
                            </a>
...
`)
        ...
        //< div class="modal fade bd-example-modal-xl show" id = "goodmodal" tabindex = "-1" role = "dialog" aria - labelledby="myExtraLargeModalLabel" aria - hidden="true" >
